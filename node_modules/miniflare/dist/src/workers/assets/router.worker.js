...
var src_default = {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      return env.CONFIG.has_user_worker && !assetsExist ? (analytics.setData({ dispatchtype: "worker" /* WORKER */ }), await env.JAEGER.enterSpan("dispatch_worker", async (span) => (span.setTags({
        hasUserWorker: env.CONFIG.has_user_worker || !1,
        asset: assetsExist,
        dispatchType: "worker" /* WORKER */
